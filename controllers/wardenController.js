...
const loadDashboard = async (req, res) => {
    ...
    try {
        ...
        res.render('dashboard', { wardenName: wardenName, hostel: hostelData, complaints: complaintData, leavesList: leaveData, hostelName: hostelData.name, recentAllocated: recentAllocated })
